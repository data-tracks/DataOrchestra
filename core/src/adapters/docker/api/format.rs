...
impl FormatBuilder {
    pub fn build(&self) -> String {
        let format = self.build_internal().expect("Unable to build format");
...
#[cfg(test)]
mod tests {
    use crate::adapters::FormatBuilder;

    #[test]
    pub fn format_name() {
        let output = FormatBuilder::default().name().build();
    ...
    #[test]
    pub fn format_id() {
        let output = FormatBuilder::default().id().build();
    ...
    #[test]
    pub fn format_image() {
        let output = FormatBuilder::default().image().build();
