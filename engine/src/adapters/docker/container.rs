...
use crate::adapters::docker::executor::DockerExecutor;
use crate::adapters::traits::Executor;
use crate::adapters::{Local, OsSystems};
use core::panic;
use log::{debug, error};
...
#[cfg(test)]
mod tests {
    use crate::adapters::{ContainerBuilder, Executor, ExecutorError, Run};
